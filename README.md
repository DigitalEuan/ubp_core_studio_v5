![ubp core studio](ubp_core_studio_v5.png)

![ubp core studio glm](ubp_core_studio_v5_glm.png)
...
*  **UBP AI/LLM Experiment**: available in the 'GLM Workspace' tab
*  **Workspace Python Scripts**: [https://github.com/DigitalEuan/UBP_Repo/tree/main/core_studio_v4.0/GLM]
*  **Still in Development**: currently 'Adversarial Stress Test' and 'Benchmarks' aren't functioning.
